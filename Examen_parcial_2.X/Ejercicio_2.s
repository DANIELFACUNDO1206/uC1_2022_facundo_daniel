...
Bucle:   
    ...
    BTFSC   parada1_int1,1,0	     ;Si parada1_int1 es 0, salta la siguiente instruccion 
    GOTO    Exit		     ;Me mandara a la etiqueta Exit cuando parada1_int1  finaliza la INT0
    MOVWF   LATC,0		     ;Voy a cargar el valor de mi tabla a mi puerto C
    MOVWF   Evidenciar_led,0
    CALL    Retardo_de_250ms
    DECFSZ  counter,1,0		     ;(counter)-1=0, saltara la instruccion siguiente
    GOTO    Inc_offset
    GOTO    Sequence_5
